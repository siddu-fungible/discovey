    ...
    def run(self):
        ...
        for count in range(self.test_iteration_count):
            ...
            for index, fs_obj in enumerate(self.fs_obj_list):
             ...
             #detaching volume before deleting
             print "Detaching a volume before delete"
             storage_controller = self.fs_obj_list[0].get_storage_controller()
             ...
             print' Deleting a volume after detaching it'
             storage_controller = self.fs_obj_list[0].get_storage_controller()
