...
#
# RCS: @(#) $Id: //TestCenter/4.81_rel/common/tools/tcl/8.5.9/linux_64/lib/tclConfig.sh#1 $
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/tmp/tcl8.5.9/unix -ltcl8.5'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/tmp/tcl/lib -ltcl8.5'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/tmp/tcl/include'
...
# compiled.
TCL_SRC_DIR='/tmp/tcl8.5.9'

# List of standard directories in which to look for packages during
# "package require" commands.  Contains the "prefix" directory plus also
# the "exec_prefix" directory, if it is different.
TCL_PACKAGE_PATH='/tmp/tcl/lib '
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/tmp/tcl8.5.9/unix -ltclstub8.5'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/tmp/tcl/lib -ltclstub8.5'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/tmp/tcl8.5.9/unix/libtclstub8.5.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/tmp/tcl/lib/libtclstub8.5.a'
