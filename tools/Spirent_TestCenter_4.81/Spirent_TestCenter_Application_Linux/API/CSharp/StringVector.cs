...
public class StringVector : global::System.IDisposable, global::System.Collections.IEnumerable
    , global::System.Collections.Generic.IList<string>
 {
  ...
  public void Clear() {
    StcIntCSharpPINVOKE.StringVector_Clear(swigCPtr);
  }
  ...
  private uint size() {
    uint ret = StcIntCSharpPINVOKE.StringVector_size(swigCPtr);
    return ret;
  }

  private uint capacity() {
    uint ret = StcIntCSharpPINVOKE.StringVector_capacity(swigCPtr);
    return ret;
  }

  private void reserve(uint n) {
    StcIntCSharpPINVOKE.StringVector_reserve(swigCPtr, n);
  }

  public StringVector() : this(StcIntCSharpPINVOKE.new_StringVector__SWIG_0(), true) {
  }

  public StringVector(StringVector other) : this(StcIntCSharpPINVOKE.new_StringVector__SWIG_1(StringVector.getCPtr(other)), true) {
    if (StcIntCSharpPINVOKE.SWIGPendingException.Pending) throw StcIntCSharpPINVOKE.SWIGPendingException.Retrieve();
  }

  public StringVector(int capacity) : this(StcIntCSharpPINVOKE.new_StringVector__SWIG_2(capacity), true) {
    if (StcIntCSharpPINVOKE.SWIGPendingException.Pending) throw StcIntCSharpPINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public void AddRange(StringVector values) {
    StcIntCSharpPINVOKE.StringVector_AddRange(swigCPtr, StringVector.getCPtr(values));
    if (StcIntCSharpPINVOKE.SWIGPendingException.Pending) throw StcIntCSharpPINVOKE.SWIGPendingException.Retrieve();
  }

  public StringVector GetRange(int index, int count) {
    global::System.IntPtr cPtr = StcIntCSharpPINVOKE.StringVector_GetRange(swigCPtr, index, count);
  ...
  public static StringVector Repeat(string value, int count) {
    global::System.IntPtr cPtr = StcIntCSharpPINVOKE.StringVector_Repeat(value, count);
    StringVector ret = (cPtr == global::System.IntPtr.Zero) ? null : new StringVector(cPtr, true);
    if (StcIntCSharpPINVOKE.SWIGPendingException.Pending) throw StcIntCSharpPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public bool Remove(string value) {
    bool ret = StcIntCSharpPINVOKE.StringVector_Remove(swigCPtr, value);
    if (StcIntCSharpPINVOKE.SWIGPendingException.Pending) throw StcIntCSharpPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
