...
class CmdController(Cmd):
    ...
    set_qos_egress_queue_buffer_parser.set_defaults(func=set_qos_egress_buffer_pool)
    get_qos_egress_queue_buffer_parser.set_defaults(func=get_qos_egress_buffer_pool)
