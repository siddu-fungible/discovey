# -*- coding: utf-8 -*-
# Generated by Django 1.11.3 on 2019-04-02 20:02
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('fun_test', '0181_volumeperformanceemulation_input_fio_job_name'),
    ]

    operations = [
        migrations.CreateModel(
            name='BltVolumePerformance',
            fields=[
                ...
                ('output_write_99_latency', models.IntegerField(default=-1, verbose_name=b'Write 99.99% latency')),
                ...
                ('output_read_99_latency', models.IntegerField(default=-1, verbose_name=b'Read 99.99% latency')),
