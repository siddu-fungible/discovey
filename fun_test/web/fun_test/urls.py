...
regression_urls = [
    ...
    url(r'^suite_execution1/(\d+)$', regression_views.suite_execution1),
    ...
    url(r'^test_case_execution1/(\d+)/(\d+)$', regression_views.test_case_execution1),
    url(r'^suite_re_run/(\d+)$', regression_views.suite_re_run),
    url(r'^test_case_re_run$', regression_views.test_case_re_run),
    url(r'^test_case_re_run1$', regression_views.test_case_re_run1),
    url(r'^log_path$', regression_views.log_path),
    url(r'^log_path1$', regression_views.log_path1),
