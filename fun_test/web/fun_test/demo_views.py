...
def fio_task(bg_execution_id, traffic_context, fio_args):
    ...
    try:
        ...
        try:
            ...
            fio_command = 'fio --name=fun_nvmeof --ioengine=fun --rw=randrw --bs="4096" --size=128k --numjobs=1  --iodepth=8 --do_verify=0 --verify=md5 --verify_fatal=1 --source_ip={} --dest_ip={} --io_queues=1 --nrfiles=1 --nqn=nqn.2017-05.com.fungible:nss-uuid1 --nvme_mode=IO_ONLY --nsid={} --time_based --runtime=20  --verify_pattern="1232"'.format(
                tg_ip, f1_ip, ns_id)
