...
if __name__ == "__main_rds_client__":
    metric_model_name = "NvmeFcpPerformance"
    description = "TBD"
    owner_info = "Manu K S  (manu.ks@fungible.com)"
    source = "https://github.com/fungible-inc/Integration/blob/master/fun_test/scripts/networking/fcp_scale/nvme_tcp_fcp.py"
    positive = False
    visualization_unit = PerfUnit.UNIT_MBITS_PER_SEC
    y1_axis_title = PerfUnit.UNIT_MBITS_PER_SEC
    platform = FunPlatform.F1
