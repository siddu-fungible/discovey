...
class BootTimePerformance(models.Model):
    ...
    status = models.CharField(max_length=30, verbose_name="Status", default=RESULTS["PASSED"])
    input_date_time = models.DateTimeField(verbose_name="Date", default=datetime.now)
    output_firmware_boot_time = models.IntegerField(verbose_name="microseconds" ,default=-1)
    output_flash_type_boot_time = models.IntegerField(verbose_name="microseconds" ,default=-1)
    output_eeprom_boot_time = models.IntegerField(verbose_name="microseconds", default=-1)
    output_sbus_boot_time = models.IntegerField(verbose_name="microseconds", default=-1)
    output_host_boot_time = models.IntegerField(verbose_name="microseconds", default=-1)
    output_main_loop_boot_time = models.IntegerField(verbose_name="microseconds", default=-1)
    output_boot_success_boot_time = models.IntegerField(verbose_name="microseconds", default=-1)
    tag = "analytics"
