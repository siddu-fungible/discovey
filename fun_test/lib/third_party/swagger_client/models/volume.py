...
class Volume(object):
    ...
    def __init__(self, name=None, uuid=None, vol_type=None, type=None, pool=None, dpu=None, capacity=None, compress=None, encrypt=None, zip_effort=None, allow_expansion=None, stripe_count=None, crc_enabled=None, crc_type='nocrc', is_clone=None, clone_source_volume_uuid=None, state=None, rebuild_state=None, rebuild_percent=None, spare_vol=None, ports=None, src_vols=None, stats=None, physical_capacity=None, additional_fields=None, created_at=None, modified_at=None):  # noqa: E501
    ...
    def src_vols(self, src_vols):
        ...
        """
        if src_vols is None:
            raise ValueError("Invalid value for `src_vols`, must not be `None`")  # noqa: E501
