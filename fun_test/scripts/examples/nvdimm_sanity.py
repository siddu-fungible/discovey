...
class NvdimmTest1(FunTestCase):
    ...
    def run(self):
        ...
        topology_helper.set_dut_parameters(dut_index=0, custom_boot_args="app=load_mods,hw_hsu_test sku=SKU_FS1600R2_0 --serial --dpc-server --dpc-uart --mgmt --all_100g --fec syslog=6 nvdimm_arm_backup=1")
