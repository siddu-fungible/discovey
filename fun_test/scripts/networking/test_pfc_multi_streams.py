...
def get_fpg_port_cbfcpause_counters(network_controller_obj, dut_port, shape, tx=False):
    output_dict = {}
    try:
...
def get_psw_port_enqueue_dequeue_counters(network_controller_obj, dut_port, hnu, pg=False):
    output_dict = {}
    dequeue = 'dequeue'
    enqueue = 'enqueue'
    if pg:
