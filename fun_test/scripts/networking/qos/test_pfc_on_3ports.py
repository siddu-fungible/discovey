...
class SpirentSetup(FunTestScript):
    ...
    def setup(self):
        global template_obj, port_1, port_2, port_3, pfc_frame, subscribe_results, network_controller_obj, dut_port_2, \
            ...
            port_3_dscp_stream_1, port_2_pfc_stream, port_obj_list
        ...
        template_obj = SpirentEthernetTrafficTemplate(session_name="test_pfc_3ports", chassis_type=chassis_type,
