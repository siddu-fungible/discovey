...
class SpirentSetup(FunTestScript):
    ...
    def setup(self):
        ...
        output = set_strict_priority_on_queue(network_controller_obj=network_controller_obj, dut_port=dut_port_2,
                                              set_queue_list=[])
...
class Cir_Q0_Q1_Q2_Q3(FunTestCase):
    ...
    def describe(self):
        self.set_test_details(id=1,
                              summary="Test shaper cir by having same ingress load such that queues get bandwidth based on cir rate for 0,1,2,3",
                              steps="""
                              ...
                              5. Verify bandwidth is such that bandwidth for queue is based on cir assigned 
                              """)
...
class Cir_Q4_Q5_Q6_Q7(Cir_Q0_Q1_Q2_Q3):
    ...
    def describe(self):
        self.set_test_details(id=2,
                              summary="Test shaper cir by having same ingress load such that queues get bandwidth "
                                      "based on cir rate for 4,5,6,7",
                              steps="""
...
class Cir_Q8_Q9_Q10_Q11(Cir_Q0_Q1_Q2_Q3):
    ...
    def describe(self):
        self.set_test_details(id=3,
                              summary="Test shaper cir by having same ingress load such that queues get "
                                      "bandwidth based on cir rate for 8,9,10,11",
                              steps="""
...
class Cir_Q12_Q13_Q14_Q15(Cir_Q0_Q1_Q2_Q3):
    ...
    def describe(self):
        self.set_test_details(id=4,
                              summary="Test shaper cir by having same ingress load such that queues get "
                                      "bandwidth based on cir rate for 12,13,14,15",
                              steps="""
