...
class NuTransitPerformance(FunTestScript):
    ...
    def cleanup(self):
        template_obj.populate_performance_counters_json(test_name="NU Transit Performance Bidirectional Fixed Frames",
                                                        latency_results=latency_results,
                                                        jitter_results=jitter_results,
                                                        file_name="nu_transit_performance_bidirectional_fixed_size")
