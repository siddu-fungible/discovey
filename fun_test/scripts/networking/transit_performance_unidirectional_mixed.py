...
class NuTransitIPv4LatencyTest(FunTestCase):
    subscribe_results = {}
    ...
    def describe(self):
        self.set_test_details(id=1,
                              summary="NU Transit Performance Unidirectional Latency Test (Mixed Size Frames IPv4)",
                              steps="""
                              1. Get port handles
    ...
    def setup(self):
        ...
        fun_test.simple_assert(ports, "Get Port handle")
        self.port = ports[0]
...
class NuTransitLatencyIpv6Test(NuTransitIPv4LatencyTest):
    def describe(self):
...
if __name__ == "__main__":
    ...
    if test_case_mode == 6:
        ...
        ts.add_test_case(NuTransitIPv4LatencyTest())
