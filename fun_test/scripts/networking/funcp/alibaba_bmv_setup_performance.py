...
from scripts.networking.funcp import fs_power_cycle_test
...
class SetupClass(FunTestScript):
    server_key = {}
    ...
    def setup(self):
        ...
        funcp_obj = FunControlPlaneBringup(fs_name=server_key["fs"][fs_name]["fs-name"])
...
class SetupBringup(fs_power_cycle_test.BootF1):
...
class HuHuFCP(FunPerformance):
    def describe(self):
        self.set_test_details(id=2, summary="HU HU FCP perf",
                              steps="""
