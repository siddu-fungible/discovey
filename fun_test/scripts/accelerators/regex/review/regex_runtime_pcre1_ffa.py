...
class Pcre1FfaRuntime(HigherLevelTestcase):
    def describe(self):
    ...
    def setup(self):
        super(Pcre1FfaRuntime, self).setup()

    def run(self):
        super(Pcre1FfaRuntime, self).run()

    def cleanup(self):
        super(Pcre1FfaRuntime, self).cleanup()

class Pcre1FfaMatchAcrossPackets(HigherLevelTestcase):
    def describe(self):
    ...
    def setup(self):
        super(Pcre1FfaMatchAcrossPackets, self).setup()

    def run(self):
        super(Pcre1FfaMatchAcrossPackets, self).run()

    def cleanup(self):
        super(Pcre1FfaMatchAcrossPackets, self).cleanup()


class Pcre1FfaRuntimeSerial1(HigherLevelTestcase):
    def describe(self):
    ...
    def setup(self):
        super(Pcre1FfaRuntimeSerial1, self).setup()

    def run(self):
        super(Pcre1FfaRuntimeSerial1, self).run()

    def cleanup(self):
        super(Pcre1FfaRuntimeSerial1, self).cleanup()

class Pcre1FfaRuntimeSerial2(HigherLevelTestcase):
    def describe(self):
    ...
    def setup(self):
        super(Pcre1FfaRuntimeSerial2, self).setup()

    def run(self):
        super(Pcre1FfaRuntimeSerial2, self).run()

    def cleanup(self):
        super(Pcre1FfaRuntimeSerial2, self).cleanup()
...
if __name__ == "__main__":
    ...
    myscript.add_test_case(Pcre1FfaRuntime())
    myscript.add_test_case(Pcre1FfaMatchAcrossPackets())
    myscript.add_test_case(Pcre1FfaRuntimeSerial1())
    myscript.add_test_case(Pcre1FfaRuntimeSerial2())
    myscript.run()
