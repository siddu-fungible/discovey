...
class SnortNFA_Basic_Runtime(Snort):
    def describe(self):
    ...
    def setup(self):
        super(SnortNFA_Basic_Runtime, self).setup()

    def run(self):
        super(SnortNFA_Basic_Runtime, self).run()

    def cleanup(self):
        super(SnortNFA_Basic_Runtime, self).cleanup()


class SnortNFA_MatchAcrossPacket(Snort):
    def describe(self):
    ...
    def setup(self):
        super( SnortNFA_MatchAcrossPacket, self).setup()

    def run(self):
        super( SnortNFA_MatchAcrossPacket, self).run()

    def cleanup(self):
        super( SnortNFA_MatchAcrossPacket, self).cleanup()

class SnortNFA_Sequential1(Snort):
    def describe(self):
    ...
    def setup(self):
        super(SnortNFA_Sequential1, self).setup()

    def run(self):
        super(SnortNFA_Sequential1, self).run()

    def cleanup(self):
        super(SnortNFA_Sequential1, self).cleanup()

class SnortNFA_Sequential2(Snort):
    def describe(self):
    ...
    def setup(self):
        super(SnortNFA_Sequential2, self).setup()

    def run(self):
        super(SnortNFA_Sequential2, self).run()

    def cleanup(self):
        super(SnortNFA_Sequential2, self).cleanup()

class SnortNFA_parallel1(Snort):
    def describe(self):
    ...
    def setup(self):
        super(SnortNFA_parallel1, self).setup()

    def run(self):
        super(SnortNFA_parallel1, self).run()

    def cleanup(self):
        super(SnortNFA_parallel1, self).cleanup()


class SnortNFA_parallel2(Snort):
    def describe(self):
    ...
    def setup(self):
        super(SnortNFA_parallel2, self).setup()

    def run(self):
        super(SnortNFA_parallel2, self).run()

    def cleanup(self):
        super(SnortNFA_parallel2, self).cleanup()
...
if __name__ == "__main__":
    ...
    myscript = MyScript()
    myscript.add_test_case(SnortNFA_Basic_Runtime())
    #myscript.add_test_case(SnortNFA_MatchAcrossPacket())
    #myscript.add_test_case(SnortNFA_Sequential1())
    #myscript.add_test_case(SnortNFA_Sequential2())
    #myscript.add_test_case(SnortNFA_parallel1())
    #myscript.add_test_case(SnortNFA_parallel2())
    myscript.run()
