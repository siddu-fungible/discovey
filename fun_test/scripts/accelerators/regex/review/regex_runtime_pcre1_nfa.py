...
class Pcre1NfaRuntime(HigherLevelTestcase):
    def describe(self):
        self.set_test_details(id=1,
                              summary="F1:Runtime: DFA Graphs, default args",
                              steps="""
        1. Steps 1
        2. Steps 2
        3. Steps 3
    ...
    def setup(self):
        super(Pcre1NfaRuntime, self).setup()

    def run(self):
        super(Pcre1NfaRuntime, self).run()

    def cleanup(self):
        super(Pcre1NfaRuntime, self).cleanup()

class Pcre1NfaMatchAcrossPackets(HigherLevelTestcase):
    def describe(self):
        self.set_test_details(id=2,
                              summary="F1:Runtime: match across packets NFA Graphs, default args",
                              steps="""
        1. Steps 1
        2. Steps 2
        3. Steps 3
    ...
    def setup(self):
        super(Pcre1NfaMatchAcrossPackets, self).setup()

    def run(self):
        super(Pcre1NfaMatchAcrossPackets, self).run()

    def cleanup(self):
        super(Pcre1NfaMatchAcrossPackets, self).cleanup()


class Pcre1NfaRuntimeSerial1(HigherLevelTestcase):
    def describe(self):
        self.set_test_details(id=3,
                              summary="F1:Runtime: Serial1 NFA Graphs, default args",
                              steps="""
        1. Steps 1
        2. Steps 2
        3. Steps 3
    ...
    def setup(self):
        super(Pcre1NfaRuntimeSerial1, self).setup()

    def run(self):
        super(Pcre1NfaRuntimeSerial1, self).run()

    def cleanup(self):
        super(Pcre1NfaRuntimeSerial1, self).cleanup()

class Pcre1NfaRuntimeSerial2(HigherLevelTestcase):
    def describe(self):
        self.set_test_details(id=4,
                              summary="F1:Runtime: Serial2 NFA Graphs, default args",
                              steps="""
        1. Steps 1
        2. Steps 2
        3. Steps 3
    ...
    def setup(self):
        super(Pcre1NfaRuntimeSerial2, self).setup()

    def run(self):
        super(Pcre1NfaRuntimeSerial2, self).run()

    def cleanup(self):
        super(Pcre1NfaRuntimeSerial2, self).cleanup()
...
if __name__ == "__main__":
    ...
    myscript.add_test_case(Pcre1NfaRuntime())
    myscript.add_test_case(Pcre1NfaMatchAcrossPackets())
    myscript.add_test_case(Pcre1NfaRuntimeSerial1())
    myscript.add_test_case(Pcre1NfaRuntimeSerial2())
    myscript.run()
