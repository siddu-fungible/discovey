...
class DfaRuntime(HigherLevelTestcase):
    def describe(self):
    ...
    def setup(self):
        super(DfaRuntime, self).setup()

    def run(self):
        super(DfaRuntime, self).run()

    def cleanup(self):
        super(DfaRuntime, self).cleanup()

class DfaRuntimeMatchAcrossPackets(HigherLevelTestcase):
    def describe(self):
        self.set_test_details(id=2,
                              summary="F1:Runtime: match across packets DFA Graphs, default args",
                              steps="""
        1. Steps 1
        2. Steps 2
        3. Steps 3
    ...
    def setup(self):
        super(DfaRuntimeMatchAcrossPackets, self).setup()

    def run(self):
        super(DfaRuntimeMatchAcrossPackets, self).run()

    def cleanup(self):
        super(DfaRuntimeMatchAcrossPackets, self).cleanup()


class DfaRuntimeSerial1(HigherLevelTestcase):
    def describe(self):
        self.set_test_details(id=3,
                              summary="F1:Runtime: Serial1 DFA Graphs, default args",
                              steps="""
        1. Steps 1
        2. Steps 2
        3. Steps 3
    ...
    def setup(self):
        super(DfaRuntimeSerial1, self).setup()

    def run(self):
        super(DfaRuntimeSerial1, self).run()

    def cleanup(self):
        super(DfaRuntimeSerial1, self).cleanup()

class DfaRuntimeSerial2(HigherLevelTestcase):
    def describe(self):
        self.set_test_details(id=4,
                              summary="F1:Runtime: Serial2 DFA Graphs, default args",
                              steps="""
        1. Steps 1
        2. Steps 2
        3. Steps 3
    ...
    def setup(self):
        super(DfaRuntimeSerial2, self).setup()
...
if __name__ == "__main__":
    ...
    myscript.add_test_case(DfaRuntime())
    myscript.add_test_case(DfaRuntimeMatchAcrossPackets())
    myscript.add_test_case(DfaRuntimeSerial1())
    myscript.add_test_case(DfaRuntimeSerial2())
    myscript.run()
