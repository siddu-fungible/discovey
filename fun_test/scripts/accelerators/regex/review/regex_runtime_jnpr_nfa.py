...
class HigherLevelTestcase(FunTestCase):
    ...
    def run(self):
        ...
        for json in self.jsons:
            ...
            boot_args = "app=pm_test_bootstrap rbm-size=" + rbm_size + " param-file=" + json + " --disable-wu-watchdog"
...
class JuniperNfaDflt10(HigherLevelTestcase):
    def describe(self):
        self.set_test_details(id=3,
                              summary="Runtime: Jnpr NFA Graphs, default args, (10th set of graphs)",
                              steps="""
        1. Steps 1
        2. Steps 2
        3. Steps 3
    ...
    def setup(self):
        super(JuniperNfaDflt10, self).setup()

    def run(self):
        super(JuniperNfaDflt10, self).run()

    def cleanup(self):
        super(JuniperNfaDflt10, self).cleanup()

class JuniperNfaDflt1(HigherLevelTestcase):
    def describe(self):
        self.set_test_details(id=4,
                              summary="Runtime: Jnpr NFA Graphs, default args, (1st set of graphs)",
                              steps="""
        1. Steps 1
        2. Steps 2
        3. Steps 3
    ...
    def setup(self):
        super(JuniperNfaDflt1, self).setup()

    def run(self):
        super(JuniperNfaDflt1, self).run()

    def cleanup(self):
        super(JuniperNfaDflt1, self).cleanup()


if __name__ == "__main__":
    myscript = MyScript()

    myscript.add_test_case(JuniperNfaDflt10())
    myscript.add_test_case(JuniperNfaDflt1())
