...
class JuniperFFA_MatchAcrossPacket(HigherLevelTestcase):
    def describe(self):
        self.set_test_details(id=2,
                              summary="S1:JUNIPER NFA match across packet",
                              steps="""
        1. Steps 1
        2. Steps 2
        3. Steps 3
...
class JuniperFFA_Sequential1(HigherLevelTestcase):
    def describe(self):
        self.set_test_details(id=3,
                              summary="S1:JUNIPER NFA LSU serial:loading graphs on different clusters",
                              steps="""
        1. Steps 1
        2. Steps 2
        3. Steps 3
...
class JuniperFFA_Sequential2(HigherLevelTestcase):
    def describe(self):
        self.set_test_details(id=4,
                              summary="S1:JUNIPER NFA LSU serial:loading graphs on single cluster",
                              steps="""
        1. Steps 1
        2. Steps 2
        3. Steps 3
...
class JuniperFFA_parallel1(HigherLevelTestcase):
    def describe(self):
        self.set_test_details(id=5,
                              summary="S1:JUNIPER NFA LSU parallel:loading graphs on different cluster",
                              steps="""
        1. Steps 1
        2. Steps 2
        3. Steps 3
...
class JuniperFFA_parallel2(HigherLevelTestcase):
    def describe(self):
        self.set_test_details(id=6,
                              summary="S1:JUNIPER NFA LSU parallel:loading graphs on single cluster",
                              steps="""
        1. Steps 1
        2. Steps 2
        3. Steps 3
