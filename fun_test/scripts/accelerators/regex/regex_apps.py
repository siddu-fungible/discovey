...
class FunTestCase1(FunTestCase):
    ...
    def run(self):
        ...
        build_result = jenkins_manager.build(params=params, extra_emails=["john.abraham@fungible.com,team-regression@fungible.com,jitendra.lulla@fungible.com"], wait_time_for_build_complete=25 * 60)
