...
TERAMARK_ZIP_TAG = "zip_teramark"
TOTAL_NUMBER_OF_TEST_CASES = 26
...
if __name__ == "__main__":
    script = PalladiumAppParserScript(tag=TERAMARK_ZIP_TAG)
    script.add_test_case(RetrieveLogLinesCase(tag=TERAMARK_ZIP_TAG))
