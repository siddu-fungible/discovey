    ...
    def cleanup(self):
        try:
            ...
            fun_test.scp(source_port=bmc_handle.ssh_port, source_username=bmc_handle.ssh_username,
                         ...
                         source_file_path="/mnt/sdmmc0p1/log/f1_0_uart_log.txt", target_file_path=uart_artifact_file)
            fun_test.add_auxillary_file(description="fs44_f1_0_uart_log.txt", filename=uart_artifact_file)
