...
from web.fun_test.metrics_models import HuRawVolumePerformance
from datetime import datetime

HU_PERF_XLSX = LOGS_DIR + "/hu_performance.xlsx"
...
class HuPerformanceTc(FunTestCase):
    def describe(self):
        self.set_test_details(id=1,
                              summary="HU performance",
                              steps="Steps 1")
    ...
    def run(self):
        pe = PerformanceExcel(workbook_filename=HU_PERF_XLSX)
        sheet_name = "hu"
