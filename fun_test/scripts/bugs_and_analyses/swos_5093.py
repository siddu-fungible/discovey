...
class FunTestCase1(FunTestCase):
    ...
    def run(self):
        ...
        topology_helper.set_dut_parameters(dut_index=0, custom_boot_args="setenv bootargs app=mdt_test,hw_hsu_test --serial sku=SKU_FS1600_0 --dpc-server --dpc-uart retimer=0,1  --nofreeze syslog=2")
